...
// Per-skill-pack agent instruction templates for Amplify.
...
enum CLAUDETemplate {
    ...
    **Output format rules:**
    ...
    - Do not list patterns already covered by the Humanizer Anti-Patterns section in \(WorkspaceInstructionFile.fileName) — write "See humanizer list" and move on
    ...
    **Behavior:**
    ...
    /// Generates a personalized agent instructions file for the given author and use case.
    ...
    static func generate(name: String, useCase: String) -> String {
        ...
        workspace/
          ...
          \(WorkspaceInstructionFile.fileName)  # This file — your operating instructions
        ```
        """###
    ...
    /// Agent instructions for gstack workflows. Includes installation guide and full command reference.
    ...
    /// Minimal agent instructions for blank workspaces — just the author name and basic rules.
